...
<gameSystem id="sys-c646-d5a1-2146-1042" name="Carnevale" battleScribeVersion="2.03" revision="1" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <forceEntries>
    <forceEntry name="Gang" hidden="false" id="aeb3-6915-af1f-2a80">
      <categoryLinks>
        <categoryLink name="Leader" hidden="false" id="5c90-5eb9-1242-6f1b" targetId="955d-3f8e-a1e3-88b9" type="category">
          <constraints>
        ...
        <categoryLink name="Hero" hidden="false" id="5f2a-adb2-6c7f-4f5e" targetId="79d4-9b8b-7f29-cba5" type="category">
          <constraints>
          ...
          <modifiers>
            <modifier type="increment" value="1" field="5eb8-972a-9158-571b">
              <repeats>
                <repeat value="1" repeats="1" field="selections" scope="force" childId="cf01-1b3c-22d7-8d1b" shared="true" roundUp="false" includeChildSelections="true"/>
              </repeats>
            </modifier>
          </modifiers>
        </categoryLink>
        <categoryLink name="Henchman" hidden="false" id="6e01-147a-211b-9ef2" targetId="cf01-1b3c-22d7-8d1b" type="category"/>
      </categoryLinks>
    </forceEntry>
  </forceEntries>
</gameSystem>
